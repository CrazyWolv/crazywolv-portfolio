                   ...
                   {/* Flip the card "Button" */}
                    ...
                    <div className="flip-arrow absolute font-bold text-2xl text-[#4fb4f2] cursor-pointer bottom-2 right-2 w-[40px] h-[40px] flex items-center justify-center z-10" onClick={() => (setIsFlipped(!isFlipped))}>↺</div>
                        ...
                        <div className="absolute w-full flex justify-center text-center">
                                ...
                                {/* Project Description */}
                                <div className="absolute w-full text-sm pl-10 pr-10 pt-10 md:pt-20 md:text-base">
                                    {desc}

                                {/* Techs Used */}
                                    <div className="relative w-3/4 md:w-full pt-2">
                                ...
                                <div className="flex items-center justify-center w-full">
                                    ...
                                    { gitHub === "" ? <p className="absolute bottom-3 left-5 md:bottom-5 md:left-5 font-bold flex items-center gap-x-1 md:gap-x-2 text-grey">
