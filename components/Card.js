                        ...
                        <div className="absolute w-full flex justify-center text-center">
                                ...
                                <div className="flex items-center justify-center w-full">
                                    ...
                                    { link === "WIP" || link === "" ? <p className="absolute py-2 px-3 md:py-1 md:px-3 bottom-3 md:bottom-3 lg:py-3 lg:py-5 lg:bottom-5 rounded-md bg-dark font-bold">
                                        Work in Progress
                                    </p> : <a href={link} target="_blank" className="absolute py-2 px-3 md:py-1 md:px-3 bottom-3 md:bottom-3 lg:py-3 lg:py-5 lg:bottom-5 rounded-md bg-[#4fb4f2] font-bold">
                                        Découvrez-moi !
                                    </a>
                                    } 
