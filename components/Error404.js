            ...
            <section className="bg-white dark:bg-dark">
                <div className="flex flex-col-reverse items-center w-full mx-auto overflow-hidden py-10 lg:flex-row lg:justify-around">
                    <div className="w-full lg:w-1/2 bg-white dark:bg-dark flex flex-col items-center gap-y-3 px-6">
                        ...
                        <p className="w-3/4 px-3 py-2 text-xl leading-loose">Il semblerait que vous ayez perdu votre chemin ! Lorsque vous aurez fini d'observer cet adorable boule de poils, vous pourrez cliquer <a href="/" target="_blank" className="errorLink hover:errorLinkHover">ici</a> ou même encore <a href="/" target="_blank" className="errorLink hover:errorLinkHover">là</a> pour <span className="font-bold">revenir à l'accueil</span>.</p>
                    </div>
