        ...
        <section className="bg-white dark:bg-dark">
            ...
            <div className="bg-white dark:bg-dark max-w-6xl text-xl pb-20 mx-auto flex-col -mt-15 md:-mt-0">
                <div className="py-10 pl-10 bg-light">
                    <p className="text-5xl text-lightThemeText dark:text-darkThemeText">Je suis {allData.about.title} qui code actuellement le projet <a className="title" href={allData.about.currentProjectUrl} target="_blank" rel="noreferrer">{allData.about.currentProject}</a></p>
                </div>
                <div className="mx-auto relative md:flex md:flex-row-reverse gap-x-15">
                    <div className="w-full px-2 py-2">
                        ...
                        <div className="w-full py-5">
                            <p className="min-w-[7rem] max-w-[9rem] ml-7 my-10 py-3 text-2xl bg-dark rounded-md text-center text-lightThemeText dark:text-darkThemeText dark:bg-light">Hard Skills</p>
                    ...
                    <div className="bg-light px-5 md:w-1/2 bottom-0 flex flex-col item-center">
                        ...
                        <div className="my-3">
                            ...
                            <div className="flex flex-col gap-y-5">
                                <p className="text-lightThemeText dark:text-darkThemeText">→ <a href={allData.socialLinks.twitter}>Twitter</a></p>
                                <p className="text-lightThemeText dark:text-darkThemeText">→ <a href={allData.socialLinks.linkedin}>LinkedIn</a></p>
                                <p className="text-lightThemeText dark:text-darkThemeText">→ <a href={allData.socialLinks.github}>GitHub</a></p>
                            </div>
                        </div>
                    </div>
                </div>
